...
namespace StardewDS
{
    ...
    /// the bottom nav's backpack/map/crafting tab icons, plus the
    ...
    /// where inventory=0, map=3, crafting=4.
    /// </summary>
    internal static class UiIconCache
    {
        ...
        /// <summary>Returns the cached PNG bytes for the icon named <paramref name="name"/> ("backpack", "map", or "crafting"), or null if unknown or not cached yet. Safe to call from any thread.</summary>
